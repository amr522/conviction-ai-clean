...
class TestCalculateFeatures:
    ...
    def test_rolling_macro_features(self):
        ...
        assert actual_fred_mean[2] == pytest.approx(5.30, abs=1e-6)  # (5.25+5.30+5.35)/3
        assert actual_fred_mean[3] == pytest.approx(5.35, abs=1e-6)  # (5.30+5.35+5.40)/3
        assert actual_fred_mean[4] == pytest.approx(5.40, abs=1e-6)  # (5.35+5.40+5.45)/3
