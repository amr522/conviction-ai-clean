...
from utils.delta_writer import write_delta_table, read_delta_table, get_delta_table_history
...
class TestDeltaWriter:
    ...
    def test_read_delta_table_time_travel(self, mock_spark_session):
        ...
        result = read_delta_table(
            f"{self.temp_dir}/test.delta",
            timestamp_as_of="2025-01-16T00:00:00Z"
        )
...
def test_delta_writer_imports():
    ...
    try:
        from utils.delta_writer import write_delta_table, read_delta_table, get_delta_spark_session
