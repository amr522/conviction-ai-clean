...
with patch("aws_xray_sdk.core.xray_recorder"), patch(
...
class TestInferenceAPI:
    ...
    def test_predict_endpoint_with_feature_store(
        self, mock_get_features, mock_metadata, mock_model
    ):
        ...
        # Make request
        request_data = {"ticker": "AAPL", "timestamp": "2025-01-16T15:30:00Z"}
    ...
    def test_predict_endpoint_invalid_ticker(self):
        ...
        request_data = {"ticker": "INVALID_TICKER_TOO_LONG"}
    ...
    def test_predict_endpoint_invalid_timestamp(self):
        ...
        request_data = {"ticker": "AAPL", "timestamp": "invalid-timestamp"}
    ...
    def test_batch_predict_endpoint(self, mock_get_features, mock_metadata, mock_model):
        ...
        # Make batch request
        request_data = {
            "requests": [{"ticker": "AAPL"}, {"ticker": "MSFT"}, {"ticker": "GOOGL"}]
        }
...
def test_feature_store_utils():
    ...
    try:
        from utils.feature_store import (generate_mock_features,
                                         validate_features)
...
def test_api_imports():
    ...
    try:
        from app.main import InferenceRequest, InferenceResponse, app
