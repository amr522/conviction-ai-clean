...
from utils.performance_utils import optimize_join_performance, compute_flow_signals_optimized, compute_gamma_signals_optimized
...
class TestPerformanceUtils:
    ...
    def test_optimize_join_performance(self):
        ...
        expected_cols = {"timestamp", "ticker", "stock_price", "stock_volume", "opt_strike", "opt_volume"}
    ...
    def test_compute_flow_signals_optimized(self):
        ...
        # Create DataFrame with call/put volume data
        df = pl.DataFrame({
            ...
            "ticker": ["AAPL250117C00150000", "AAPL250117P00150000", "AAPL250117C00155000", "AAPL250117P00155000"],
        ...
        flow_data = result.select(["timestamp", "opt30_call_flow", "opt30_put_flow", "opt30_flow_divergence"]).unique()
    ...
    def test_compute_gamma_signals_optimized(self):
        ...
        # Create DataFrame with options data for gamma calculation
        df = pl.DataFrame({
            "underlying": ["AAPL", "AAPL", "AAPL", "AAPL", "AAPL"],
            "timestamp": [
                datetime(2025, 1, 1, 9, 30),
                datetime(2025, 1, 1, 10, 0),
        ...
        result = compute_gamma_signals_optimized(df, window=3, gamma_squeeze_multiplier=2.0)
        ...
        expected_net_gamma = [100.0, 150.0, 200.0, 250.0, 300.0]  # 0.01 * (volume * 100)
    ...
    def test_optimize_join_performance_custom_keys(self):
        ...
        assert set(result["price"].to_list()) == {150.0, 300.0}
    ...
    def test_join_performance_empty_dataframes(self):
        ...
        empty_stocks = pl.LazyFrame({
            "timestamp": [],
            "ticker": [],
            "price": []
        })
        
        empty_options = pl.LazyFrame({
            "timestamp": [],
            "ticker": [], 
            "strike": []
        })
