...
from clean_macro_data import load_news_dir, detect_backshift, load_data_source
...
class TestCleanMacroData:
    ...
    def test_load_data_source_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = load_data_source("TEST", raw_path, parquet_path, use_raw=True, is_json=True)
            assert len(result) == 2
