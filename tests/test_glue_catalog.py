...
from utils.glue_catalog import register_parquet_table, register_pipeline_tables, get_parquet_schema
...
class TestGlueCatalog:
    ...
    def test_register_parquet_table_create_new_table(self, mock_schema, mock_boto):
        ...
        mock_glue.update_table.side_effect = mock_glue.exceptions.EntityNotFoundException({}, "")
    ...
    def test_register_pipeline_tables(self, mock_register):
        ...
        expected_tables = ["stocks_daily", "options_daily", "stocks_30min", "options_30min", "intraday_master"]
...
def test_glue_catalog_imports():
    ...
    try:
        from utils.glue_catalog import register_parquet_table, register_pipeline_tables
