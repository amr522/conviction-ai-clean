...
from utils.xray_utils import (add_trace_metadata, configure_xray,
                              trace_function, traced_subsegment)
...
class TestXRayTracing:
    ...
    def test_trace_function_decorator_enabled(self, mock_recorder):
        ...
        mock_recorder.capture.return_value.__enter__ = MagicMock(
    ...
    def test_add_trace_metadata_enabled(self, mock_recorder):
        ...
        mock_recorder.put_metadata.assert_called_once_with(
            "test_key", {"data": "value"}
        )
