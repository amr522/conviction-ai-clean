...
from train_and_evaluate import main, run
...
class TestTrainAndEvaluateCLI:
    ...
    @patch("train_and_evaluate.LineageTracker")
    def test_mock_lightgbm_n_jobs(
        self, mock_lineage, mock_lgbm, mock_split, mock_prepare, mock_load
    ):
    ...
    def test_gpu_detection_fallback(
        self, mock_lineage, mock_prepare, mock_load, caplog
    ):
