...
from feast_materialize import materialize_features, get_online_features, list_feature_views
...
def test_feast_integration_imports():
    ...
    try:
        from feast_materialize import materialize_features, get_online_features
        from inference_with_feast import run_inference, get_inference_features
...
def test_inference_with_feast_mock(mock_fs_class):
    ...
    result = get_inference_features(
        tickers=["AAPL"],
        feature_views=["stocks_30min"]
    )
