...
def main():
    ...
    parser.add_argument("--traces-sample-rate", type=float, default=0.1, help="Traces sample rate (0.0-1.0)")
    parser.add_argument("--profiles-sample-rate", type=float, default=0.1, help="Profiles sample rate (0.0-1.0)")
