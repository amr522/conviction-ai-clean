...
def generate_token(
    user_id="test_user", username="test", permissions=None, test=False, quiet=False
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--permissions", nargs="+", default=["predict"], help="Permissions"
    )
    parser.add_argument(
        "--test", action="store_true", help="Generate test token with all permissions"
    )
