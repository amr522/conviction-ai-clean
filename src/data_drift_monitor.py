...
def load_reference_data(
    reference_path="datasets/processed/reference.parquet",
    use_delta=False,
    ...
    raise FileNotFoundError(
        f"No reference data found at {reference_path} or {fallback_path}"
    )


def generate_drift_report(
    current_data, reference_data, start_date, output_dir="metrics"
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--start-date", required=True, help="Date to analyze (YYYY-MM-DD)"
    )
