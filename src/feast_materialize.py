...
if __name__ == "__main__":
    ...
    parser.add_argument("--action", choices=["materialize", "list", "get-online"], 
                       required=True, help="Action to perform")
    parser.add_argument("--start-date", help="Start date (YYYY-MM-DD)")
    parser.add_argument("--end-date", help="End date (YYYY-MM-DD)")
    parser.add_argument("--feature-views", nargs="+", help="Feature views to materialize")
    parser.add_argument("--ticker", help="Ticker for online features")
    parser.add_argument("--features", nargs="+", help="Feature names for online retrieval")
