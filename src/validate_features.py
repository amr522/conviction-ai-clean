...
def main():
    parser = argparse.ArgumentParser(
        description="Validate feature matrix against expected features"
    )
    parser.add_argument(
        "--features-list", required=True, help="Path to features list markdown file"
    )
    parser.add_argument(
        "--feature-table", required=True, help="Path to feature table parquet file"
    )
