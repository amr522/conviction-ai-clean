...
# JWT Configuration
JWT_SECRET = os.getenv("JWT_SECRET", "conviction-ai-super-secret-key-change-in-production")
JWT_ALGORITHM = "HS256"
...
def optional_auth(credentials: HTTPAuthorizationCredentials = Depends(security)) -> Optional[TokenData]:
    """
